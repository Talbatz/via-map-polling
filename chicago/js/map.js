...
function onEachFeature(feature, layer) {
  ...
  if (name !== "Current Service Area"){
    container.on('click', '#vote', function(event) {
        ...
        window.open('https://docs.google.com/forms/d/e/1FAIpQLSd3mFDzpEemHV1XdwbPHNw0nvZV5f-5zkpZFskJaYl6nMh50A/formResponse?usp=pp_url&ifq&entry.473915152='+name+'&entry.183451837='+$('#email').val()+'&submit=submit', '_blank');
    });
